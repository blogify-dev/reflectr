...
import reflectr.computed.models.ComputedPropertyDelegate
import reflectr.computed.resolveComputedProps
import reflectr.extensions.subTypeOf
...
/**
 * Slices a resource with all of its properties except ones annotated with [reflectr.annotations.Hidden], or according
